...
extern hl_type t$$SimpleCanvasTest;
extern hl_type t$SimpleCanvasTest;
...
void fun$init() {
	...
	r1 = &t$$SimpleCanvasTest;
	r2 = &t$SimpleCanvasTest;
	r3 = (vbyte*)USTR("SimpleCanvasTest");
	r4 = Type_initClass(r1,r2,r3);
	r1 = &t$$Std;
	r2 = &t$Std;
	r3 = (vbyte*)USTR("Std");
	...
	r4 = Type_initClass(r1,r2,r3);
	if( r0 ) goto label$e988165_1_199;
	return;
	label$e988165_1_199:
