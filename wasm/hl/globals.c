...
String s$Timer_created_callback_assigned = 0;
String s$8060674 = 0;
String s$_Animation_loop_STARTED_ = 0;
String s$animationLoop = 0;
String s$_Frame_ = 0;
String s$_Animation_running_smoothly_ = 0;
String s$_ERROR_in_animation_loop_ = 0;
$Math g$_Math = 0;
...
String s$_CANVAS_clear_called_rgb_ = 0;
String s$c0cb5f0 = 0;
String s$WasmCanvas_hx = 0;
String s$WasmCanvas = 0;
String s$clear = 0;
String s$_CANVAS_clear_returned = 0;
String s$d9b6688 = 0;
String s$_r_ = 0;
String s$fillCircle = 0;
...
static struct _String const_s$Timer_created_callback_assigned = {&t$String,(vbyte*)USTR("Timer created, callback assigned"),32};
static struct _String const_s$8060674 = {&t$String,(vbyte*)USTR("Main() is about to exit - MainLoop should start automatically"),61};
static struct _String const_s$_Animation_loop_STARTED_ = {&t$String,(vbyte*)USTR("🎬 Animation loop STARTED!"),26};
static struct _String const_s$animationLoop = {&t$String,(vbyte*)USTR("animationLoop"),13};
static struct _String const_s$_Frame_ = {&t$String,(vbyte*)USTR("✓ Frame "),8};
static struct _String const_s$_Animation_running_smoothly_ = {&t$String,(vbyte*)USTR(" - Animation running smoothly!"),30};
static struct _String const_s$_ERROR_in_animation_loop_ = {&t$String,(vbyte*)USTR("❌ ERROR in animation loop: "),27};
...
static struct _String const_s$_CANVAS_clear_called_rgb_ = {&t$String,(vbyte*)USTR("[CANVAS] clear() called: rgb("),29};
static struct _String const_s$c0cb5f0 = {&t$String,(vbyte*)USTR(","),1};
static struct _String const_s$WasmCanvas_hx = {&t$String,(vbyte*)USTR("WasmCanvas.hx"),13};
static struct _String const_s$WasmCanvas = {&t$String,(vbyte*)USTR("WasmCanvas"),10};
static struct _String const_s$clear = {&t$String,(vbyte*)USTR("clear"),5};
static struct _String const_s$_CANVAS_clear_returned = {&t$String,(vbyte*)USTR("[CANVAS] clear() returned"),25};
static struct _String const_s$d9b6688 = {&t$String,(vbyte*)USTR("[CANVAS] fillCircle() called: pos("),34};
static struct _String const_s$_r_ = {&t$String,(vbyte*)USTR(") r:"),4};
static struct _String const_s$fillCircle = {&t$String,(vbyte*)USTR("fillCircle"),10};
...
void hl_init_roots() {
	...
	s$Timer_created_callback_assigned = &const_s$Timer_created_callback_assigned;
	s$8060674 = &const_s$8060674;
	s$_Animation_loop_STARTED_ = &const_s$_Animation_loop_STARTED_;
	s$animationLoop = &const_s$animationLoop;
	s$_Frame_ = &const_s$_Frame_;
	s$_Animation_running_smoothly_ = &const_s$_Animation_running_smoothly_;
	s$_ERROR_in_animation_loop_ = &const_s$_ERROR_in_animation_loop_;
	...
	s$_CANVAS_clear_called_rgb_ = &const_s$_CANVAS_clear_called_rgb_;
	s$c0cb5f0 = &const_s$c0cb5f0;
	s$WasmCanvas_hx = &const_s$WasmCanvas_hx;
	s$WasmCanvas = &const_s$WasmCanvas;
	s$clear = &const_s$clear;
	s$_CANVAS_clear_returned = &const_s$_CANVAS_clear_returned;
	s$d9b6688 = &const_s$d9b6688;
	s$_r_ = &const_s$_r_;
	s$fillCircle = &const_s$fillCircle;
