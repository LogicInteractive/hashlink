...
String s$_Clearing_canvas_ = 0;
String s$_Drawing_grid_ = 0;
String s$_Drawing_ball_ = 0;
String s$_Drawing_circles_ = 0;
String s$_Drawing_shapes_ = 0;
String s$_Drawing_text_ = 0;
String s$_Updating_physics_ = 0;
String s$_Frame_ = 0;
String s$_complete = 0;
...
static struct _String const_s$0b30e39 = {&t$String,(vbyte*)USTR("🎬 Animation loop STARTED! First frame rendering..."),51};
static struct _String const_s$animationLoop = {&t$String,(vbyte*)USTR("animationLoop"),13};
static struct _String const_s$_Clearing_canvas_ = {&t$String,(vbyte*)USTR("  → Clearing canvas..."),22};
static struct _String const_s$_Drawing_grid_ = {&t$String,(vbyte*)USTR("  → Drawing grid..."),19};
static struct _String const_s$_Drawing_ball_ = {&t$String,(vbyte*)USTR("  → Drawing ball..."),19};
static struct _String const_s$_Drawing_circles_ = {&t$String,(vbyte*)USTR("  → Drawing circles..."),22};
static struct _String const_s$_Drawing_shapes_ = {&t$String,(vbyte*)USTR("  → Drawing shapes..."),21};
static struct _String const_s$_Drawing_text_ = {&t$String,(vbyte*)USTR("  → Drawing text..."),19};
static struct _String const_s$_Updating_physics_ = {&t$String,(vbyte*)USTR("  → Updating physics..."),23};
static struct _String const_s$_Frame_ = {&t$String,(vbyte*)USTR("✓ Frame "),8};
static struct _String const_s$_complete = {&t$String,(vbyte*)USTR(" complete"),9};
...
void hl_init_roots() {
	...
	s$0b30e39 = &const_s$0b30e39;
	s$animationLoop = &const_s$animationLoop;
	s$_Clearing_canvas_ = &const_s$_Clearing_canvas_;
	s$_Drawing_grid_ = &const_s$_Drawing_grid_;
	s$_Drawing_ball_ = &const_s$_Drawing_ball_;
	s$_Drawing_circles_ = &const_s$_Drawing_circles_;
	s$_Drawing_shapes_ = &const_s$_Drawing_shapes_;
	s$_Drawing_text_ = &const_s$_Drawing_text_;
	s$_Updating_physics_ = &const_s$_Updating_physics_;
	s$_Frame_ = &const_s$_Frame_;
	s$_complete = &const_s$_complete;
